...
#else
    return ERROR_CODE::ERROR_NOT_SUPPORT_API;
#endif
}
...
enum ERROR_CODE updateScreenCaptureRegion2(IRtcEngineBridge_ptr apiBridge,
                                          struct Rect *rect) {
#if defined(_WIN32)
  CHECK_PTR_INT(apiBridge)
  Rect mRect;
...
enum ERROR_CODE audio_device_getDeviceMute(void *apiBridge,
  ...
  case DEVICE_TYPE::RECORDING_DEVICE: {
    ...
    ERROR_CODE error_code1 = ERROR_CODE(
        AudioPlaybackDeviceManagerBridge_ptr->getDeviceMute(&mutes1));
    *mute = mutes1;
    return error_code1;
  }
